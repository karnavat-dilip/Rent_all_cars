-- MySQL dump 10.13  Distrib 8.0.38, for macos14.4 (arm64)
--
-- Host: localhost    Database: rentall_cars_v_3_1_5
-- ------------------------------------------------------
...
CREATE TABLE `FailedTransactionHistory` (
  ...
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `payoutType` enum('claimPayout','payout') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'payout',
  PRIMARY KEY (`id`),
  KEY `reservationId` (`reservationId`),
...
CREATE TABLE `ImageBanner` (
  ...
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `buttonLabel2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `buttonLink2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `buttonLink1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Reservation` (
  ...
  `claimReason` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `hostServiceFeeType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hostServiceFeeValue` float DEFAULT NULL,
  `bookingType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payoutTransactionId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SiteSettings` VALUES (1,'Site Name','siteName','Your Site','site_settings','2019-03-27 11:53:47','2024-06-18 07:51:11'),(2,'Site Title','siteTitle','Your Site Title','site_settings','2019-03-27 11:53:47','2024-06-18 07:51:11'),(3,'Meta Keyword','metaKeyword','Your Site Meta Keyword','site_settings','2019-03-27 11:53:47','2024-06-18 07:51:11'),(4,'Meta Discription','metaDescription','Your Site Meta Description','site_settings','2019-03-27 11:53:47','2024-06-18 07:51:11'),(10,'Facebook Link','facebookLink','https://www.facebook.com/yoursite/','site_settings','2019-03-27 11:53:47','2024-06-18 07:51:11'),(11,'Twitter Link','twitterLink','https://twitter.com/yoursite','site_settings','2019-03-27 11:53:47','2024-06-18 07:51:11'),(12,'Instagram Link','instagramLink','https://www.instagram.com/?hl=en','site_settings','2019-03-27 11:53:47','2024-06-18 07:51:11'),(66,'Home Page Banner Layout','homePageType','4','site_settings','2019-03-27 11:53:47','2024-06-18 07:51:11'),(68,'Phone Number Status','phoneNumberStatus','1','site_settings','2019-08-06 09:21:54','2024-06-18 07:51:11'),(78,'App Available Status','appAvailableStatus','1','site_settings','2020-04-21 13:55:00','2024-06-18 07:51:11'),(79,'PlayStore URL','playStoreUrl','https://play.google.com/store?hl=en','site_settings','2020-04-21 13:55:00','2024-06-18 07:51:11'),(80,'AppStore URL','appStoreUrl','https://www.apple.com/ios/app-store/','site_settings','2020-04-21 13:55:00','2024-06-18 07:51:11'),(81,'email','email','support@yoursite.com','site_settings','2020-04-21 13:55:00','2024-06-18 07:51:11'),(82,'Phone Number','phoneNumber','000000000','site_settings','2020-04-21 13:55:00','2024-06-18 07:51:11'),(83,'Address','address','Location, State, Country','site_settings','2020-04-21 13:55:00','2024-06-18 07:51:11'),(84,'Stripe Publishable Key','stripePublishableKey','pk_test_C5ukBJM7qr5P1F8dY4XKhdyp','config_settings','2021-08-12 13:37:43','2024-06-24 12:46:35'),(86,'Favicon Logo','faviconLogo','31ce85192391c07ccf94c52461608a0d.png','site_settings','2022-12-22 12:49:55','2023-08-18 06:22:11'),(88,'Platform secret key','platformSecretKey','JjQI:gHf+^=D','secret_settings','2023-05-11 11:27:37','2023-05-11 11:27:37'),(89,'PushNotification Key','pushNotificationKey','AAAAK5aHG3c:APA91bG60ridFhKm7c4uAR-y_zON1wfhHpcgQWmbsU9byWDBky-7h-EEyulelmQq3CyQMOTuR347cmuXgxHruPKuU5THav1-UB440V5mRVbbfzLFZm34CB2APfDApkY7FagkrkZz796Q','config_settings','2023-08-17 13:51:25','2023-08-17 13:51:25'),(90,'Deep link Bundle Id','deepLinkBundleId','Your deep link bundle ID','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(91,'Smtp Host','smtpHost','your SMTP host','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(92,'Smtp Port','smtpPort','your SMTP port','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(93,'Smpt Email','smptEmail','your SMTP email','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(94,'Smtp Sender','smtpSender','your SMTP sender','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(95,'Smtp Sender Email','smtpSenderEmail','yourSMTP@gmail.com','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(96,'Smtp Password','smtpPassWord','your SMTP password','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(97,'Twillio Accounts Id','twillioAccountSid','Your twilio SID','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(98,'Twillio Auth Token','twillioAuthToken','Your twilio token','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(99,'Twillio Phonenumber','twillioPhone','+00000000','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(101,'Paypal Client Id','paypalClientId','Your PayPal client ID','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(102,'Paypal Secret','paypalSecret','Your PayPal secret key','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(103,'Paypal Host','paypalHost','https://api-m.sandbox.paypal.com','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(105,'Maximum image upload size','maxUploadSize','10','site_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(106,'Facebook App Id','facebookAppId','Your Facebook App Id','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(107,'Facebook Secret Id','facebookSecretId','Your Facebook Secret Id','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(108,'Google Secret Id','googleSecretId',' Your Google Secret Id','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(109,'Google Client Id','googleClientId','Your Google Client Id','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(114,'Force Update','appForceUpdate','true','appSettings','2023-08-17 13:51:25','2024-06-18 07:51:11'),(115,'Android Version','androidVersion','1.0','appSettings','2023-08-17 13:51:25','2024-06-18 07:51:11'),(116,'iOS Version','iosVersion','1.0','appSettings','2023-08-17 13:51:25','2024-06-18 07:51:11'),(117,'Deep link JSON content','deepLinkContent','Your deep link JSON content','config_settings','2023-08-17 13:51:25','2024-06-24 12:46:35'),(118,'Fcm PushNotification Key','fcmPushNotificationKey','Your FCM push notification key\n','config_settings','2023-08-17 13:51:53','2024-06-24 12:46:35'),(119,'Logo','Logo','c7230535a1aa8b026b0956c562ee761a.png','site_settings','2023-08-18 06:18:55','2024-06-18 07:51:11'),(120,'Home Page Logo','homePageLogo','e6160264a4ec2d7c93e167918560f657.png','site_settings','2023-08-18 06:21:42','2023-08-18 06:21:42'),(121,'Email Logo','emailLogo','ec598b1443c369299b5edf1f08ef96f0.png','site_settings','2023-08-18 06:22:08','2023-08-18 06:22:08'),(122,'OG Image','ogImage','63a9f103d950d5d7270ae910aaf29da1.png','site_settings','2024-06-18 07:21:17','2024-06-18 07:51:11'),(123,'Security Deposit Option','securityDepositPreference','1','site_settings','2024-06-18 07:21:17','2024-06-18 07:51:11');
...
-- Dump completed on 2024-12-19 15:59:34
